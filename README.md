...
#### ​how does the game look like ? (sketch)
![game-look](https://www.figma.com/design/g8SFkUtXf5uk8j2oG0rDnV/Wireframing--Copy-?node-id=77-432&p=f&t=j5dNhjH036NIDKWA-0)

#### Getting Started
To get started on with this Game follow these steps:
1. **Study the cards for 3 seconds**
2. **​You have 15 seconds to match or identify the cards**
3. **​Your score and remaining lives are displayed clearly on the right side of the screen**

•


### ***Future Updates***
- [ ] 6 more mood card will be added each update.
- [ ] offline version will be available soon.
- [ ] user can mute or change sound effects
- [ ] more game level will be included.
...
### ***Credits***
* Tutorial reference: [card game tutorial](https://www.youtube.com/live/rcWBLFXH7uA?si=8T4mLUzRVpdPdck8)
